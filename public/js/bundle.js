...
module.export = MonComposant = React.createClass({displayName: 'MonComposant',
    ...
    render: function(){
        ...
        return( 
        React.DOM.div({style: backgroundStyle}, 
            React.DOM.div({style: alignCenter}, " ", React.DOM.h1({style:  {color: 'floralwhite'} }, " Time passed : ",  this.state.counter, " Secondes "), " "), 
            React.DOM.div(null, " ", React.DOM.input({type: "button", style: styleButton, onClick:  this.playCounter, value:  this.state.btnValue}), " ")
        )
        );
    }
});
...
React.renderComponent( MonComposant(null), document.getElementById( 'mount-point' ) ); 
},{"./components/compteur":1,"react":146}],3:[function(require,module,exports){
/**
